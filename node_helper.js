...
module.exports = NodeHelper.create({
	...
	toggleStatusViaWebDav: async function (id, status, config, urlIndex, filename) {
		...
		const webdavUrl = 'https://baikal.ab38.de/dav.php/calendars/heiko.grossstueck@gmail.com/default/';
		const username = 'heiko.grossstueck@gmail.com';
		const password = '8JWjV7yHA3jD';
